...
# ╔═╡ 91a12a0c-218c-45a3-b44a-bd4977b8fad8
md"""
### Image Processing

"""

# ╔═╡ ee9ec5c5-0f07-4c42-82e8-c233e40c7035
begin
    I=load("./material/CityU.jpg")
end

# ╔═╡ c619328d-3cfe-49c5-8824-7d44ac29faaf
md"""
#### Sampling
"""

# ╔═╡ 382b4b07-fff6-42cc-b33c-5a77fbd50175
 r1 = @bind r1 Slider(1:40, show_value=true, default=5)

# ╔═╡ 540fa8f8-89ca-4339-be8b-1328834d1ac2
downsample_philip = I[1:r1:end, 1:r1:end]

# ╔═╡ e96e39c0-6ae9-4dee-af1f-676caa4a64f8
md"""
#### Flip upside down, left and right
"""

# ╔═╡ dd548762-1da6-4d9c-a1ba-d70e06d6a5f8
 r2 = @bind r2 Slider(1:40, show_value=true, default=5)

# ╔═╡ 76170285-ea60-4ab1-8392-eb1035e805a3
begin 
    [I[1:r2:end,end:-r2:1] I[1:r2:end,1:r2:end]; 
		I[end:-r2:1,end:-r2:1] I[end:-r2:1,1:r2:end]]
end
