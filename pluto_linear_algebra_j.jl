...
角度が $\theta=\pi/6$ のときに $st$-平面に $x$-軸と $y$-軸を書き込んでみる:
...
香港城市大学 (City University of Hong Kong) の食堂の焼きそばの画像 $384\times512\times3$ を低階最良近似してみる. 
"""
...
香港城市大学の食堂の焼きそば $384=2^7\times3$, $512=2^9$
