...
md"""
 ...
 $nbsp $nbsp
 azimuth= $(@bind longitude Slider(0:2:358, show_value=true, default=30)) deg
"""
...
begin
    surface(x4,y4,f4,
		    ...
		    camera = (-20, 30),
	        legend = :none)
	scatter!([0],[0],[0],color=:yellow,label=false,markersize=4)
	scatter!([X4[1:n4+1,1]],[X4[1:n4+1,2]],[X4[1:n4+1,3]],color=:magenta,label=false,markersize=4)
end
...
md"""
 learning rate $s$ = $(@bind s6 Slider(0.01:0.01:0.2, show_value=true, default=0.05))
...
begin
   surface(x4,y4,f4,
	        ...
	        colorbar=false,
		    camera = (-20, 30))
	scatter!([0],[0],[0],color=:yellow,label="Minimal Point",markersize=7)
	scatter!([Y4[1:n6+1,1]],[Y4[1:n6+1,2]],[Y4[1:n6+1,3]],color=:magenta,label="Newton's Method",markersize=4)
	scatter!([Y5[1:n6+1,1]],[Y5[1:n6+1,2]],[Y5[1:n6+1,3]],color=:green,label="Gradient Descent",markersize=4)
